...
from qiskit_research.protein_folding.peptide.pauli_ops_builder import (
    _build_full_identity,
)
from qiskit_research.protein_folding.peptide.beads.side_bead import SideBead

PATH = "resources/test_bead_side"


class TestSideBead(ProteinFoldingTestCase):
    """Tests Side Bead."""
